...
post('/estimate') do
  ...
  e_res = client.chat_postEphemeral(text: "Estimate of #{estimate} sent to #{ENV['CHANNEL_OR_USER']}", channel: params['channel_id'], icon_emoji: icon, username: username, as_user: false)
